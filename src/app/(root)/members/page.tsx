    ...
    <div className="relative min-h-screen bg-white dark:bg-black transition-colors duration-300">
      ...
      <div className="fixed inset-0 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-20 left-10 w-32 h-32 bg-gradient-to-r from-purple-300 to-blue-500/[0.02] rounded-full blur-xl" />
          <div className="absolute top-40 right-10 w-40 h-40 bg-gradient-to-r from-indigo-600 to-pink-500/[0.05] rounded-full blur-xl" />
          <div className="absolute bottom-20 left-20 w-48 h-48 bg-gradient-to-r from-blue-500 to-green-500/[0.03] rounded-full blur-xl" />
          <div className="absolute bottom-40 right-20 w-36 h-36 bg-gradient-to-r from-orange-500 to-red-500/[0.03] rounded-full blur-xl" />
        </div>
      </div>
